import styles from "@/app/learning-resources/learning-resources.module.css"
...
export default function Page() {
    return (
        <>
            ...
            <p>Membership may also be extended to other individuals and to persons nominated from other organisations: a fee is usually charged. Access to the Library and Resource Centre for study purposes may be made available to non-members by arrangement. Details are available in the <em>External Services</em> leaflet.</p>
            ...
            <p>Breaches of the rules may be dealt with by specific Library and Resource Centre Disciplinary Action (see below), including the withdrawal of some access, and if appropriate by invoking the College’s <em>Regulations for Students</em>, in the case of students, or in the case of staff through the appropriate College procedures as set out in the <em>Staff Handbook</em>.</p>

            <h2>Rules</h2>
            <ol className={styles.list_upper_alpha}>

                <li>Access:</li>
                <ol className={styles.list_lower_roman}>
