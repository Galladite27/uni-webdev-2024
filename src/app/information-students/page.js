...
import IMG_students from "@/../public/images/student-information/students.jpg"
    ...
    return (
        <>
            ...
            <ol>
                ...
                <li><strong>Career and Development Centr</strong>e Our Career and Development Centre is dedicated to helping you plan your future. Offering career counseling, resume workshops, and job placement services, this Centre provides the support you need to transition from student to professional. The Centre also hosts regular employer networking events and industry talks to help you build connections in your field.</li>
            ...
            {/* Image at the bottom, because it's vertical and would take too much space in the middle */}
            <Image src={IMG_students} alt="College students at work" />
        </>
    );
}
